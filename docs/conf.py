...
project = "mqml"
copyright = "Farzad Bonabi"
author = "Farzad Bonabi"
project_description = "Package required to easily run measurements and analysis for the Microsoft Quantum Materials Lyngby lab. The source codes do not include Microsoft IP and are open source, so these packages could be generally useable."
...
# auto versioning
# version = '{}'.format(mqml.__version__)
